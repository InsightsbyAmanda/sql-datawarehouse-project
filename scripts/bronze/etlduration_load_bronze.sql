/*
SETTING TIME TO TRACK ETL DURATION FOR EACH STEP IN STORED PROCEDURES
...
In order to calculate the duration, you need the starting time and the end time.
You can also calculate the Duration of Loading Bronze Layer Whole Batch. So we decalred variables for both sceanrios.
*/
